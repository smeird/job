    ...
    <section class="grid gap-6 lg:grid-cols-[420px,1fr]">
        ...
        <div class="space-y-6">
            ...
            <section class="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-6 shadow-xl">
                <header class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-semibold text-white">Tailored application runs</h3>
                        <p class="text-sm text-slate-400">Review the tailored CVs and cover letters generated by the assistant.</p>
                    </div>
